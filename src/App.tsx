                ...
                {stepImages[idx] && (
                  <div className="pt-1">
                    <img 
                      ...
                      className="w-full max-w-md rounded-lg border border-slate-200/60 shadow-xs cursor-zoom-in hover:opacity-90 hover:shadow-sm transition-all object-contain bg-slate-50"
                      onClick={() => setSelectedImage(stepImages[idx]!)}
                    />
                  </div>
                )}
              </li>
